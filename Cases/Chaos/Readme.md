...
La idea básica se centra en barrer $r$ y, para cada $r$, iterar muchas veces $x_{n+1}=r x_n(1-x_n)$; descartar los primeros pasos (transitorios) y graficar los últimos valores de $x_n$ versus $r$.[puente.lawr.ucdavis+1](https://puente.lawr.ucdavis.edu/pdf/Lesson_5_f.pdf)
...
- “Conejos” (población discreta):
  ...
  - Mapa: $x_{n+1}=r x_n (1-x_n)$, o variantes con términos de competencia o cosecha; el parámetro $r$ representa la tasa de reproducción efectiva por generación, modulable por recursos, depredación, etc.[nature+1](https://www.nature.com/articles/s41598-024-62439-8)
